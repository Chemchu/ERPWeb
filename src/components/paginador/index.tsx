export const Paginador = (props: {numPages: number, paginaActual: number, cambiarPaginaActual: Function, maxPages: number}) => {
    const offset = props.paginaActual > Math.ceil(props.maxPages / 2) + 1 ? props.paginaActual - (Math.ceil(props.maxPages/ 2) + 1 ) : 0;
