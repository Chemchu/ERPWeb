...
const BottomNavbar = (props: { IndexSeleccionado: SidebarOption; setIndex: Function }) => {
  return (
    <motion.div
      ...
      className="w-full bg-white flex h-full justify-between border shadow-lg p-2"
    >
      <div className="flex w-full h-full xl:gap-6 gap-4 justify-center items-center">
        <Link href="/dashboard">
          <div
            className={`${
              props.IndexSeleccionado === SidebarOption.Inicio && "bg-gray-100 text-blue-500"
            } hover:text-gray-800 hover:bg-gray-100 cursor-pointer dark:hover:text-white dark:hover:bg-gray-600 
        ...
        <RequireHigherAuth>
          <Link href="/dashboard/empleados">
            <div
              ...
              } hover:text-gray-800 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 
              duration-200 text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`}
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
        ...
        <RequireHigherAuth>
          <Link href="/dashboard/proveedores">
            <div
              ...
              } hover:text-blue-500 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 
              duration-200 text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`}
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
      ...
      <div className="flex w-full xl:gap-6 gap-4 justify-center items-center">
