    ...
    <form className="flex flex-col gap-4 w-full pt-10">
      ...
      <div className="flex gap-10 w-full ">
        <div className="flex flex-col gap-4 w-1/2 h-full ">
          ...
          <div className="w-full">
            <label className="block tracking-wide text-gray-700 font-bold">Dirección</label>
            <input
              ...
              id="grid-last-name"
              type="text"
              placeholder="Su dirección física"
              value={Calle}
              onChange={(e) => {
        ...
        <div className="flex flex-col gap-4 w-1/2">
          <div className="w-full">
            <label className="block tracking-wide text-gray-700 font-bold">Documento de identidad</label>
            <input
