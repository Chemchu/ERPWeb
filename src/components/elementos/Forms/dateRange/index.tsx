...
const DateRange = (props: { titulo?: string, disabled?: boolean, startDate: Date | null, endDate: Date | null, dateRange: Date[] | null[], setDateRange: Function, isClearable?: boolean }) => {
