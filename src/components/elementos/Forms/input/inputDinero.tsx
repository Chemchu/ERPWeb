...
export const InputNumber = (props: { value: string; valorPendiente: string; tipo: TipoCobro; setValue: Function }) => {
  const SetExactValue = () => {
    if (Number(props.valorPendiente) >= 0) {
      return;
    }
  ...
  return (
    <div>
      <div className="flex relative ">
        <span
          className="rounded-l-md inline-flex items-center px-3 border-t border-l border-b
        ...
        <input
          className="text-right text-xl rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
          onChange={(e) => {
