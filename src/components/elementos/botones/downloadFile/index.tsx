...
const DownloadFile = (props: { tipoDocumento: TipoDocumento }) => {
  ...
  return (
    <>
      <label
        className="flex flex-shrink-0 justify-center gap-2 w-28 py-2 text-base font-semibold cursor-pointer text-white bg-cyan-500 rounded-lg shadow-md hover:bg-cyan-600 focus:outline-none focus:ring-2 focus:ring-amber-600 focus:ring-offset-2 focus:ring-offset-blue-200"
      ...
      <AnimatePresence>{showModal && FileType()}</AnimatePresence>
    </>
  );
};
