const StatsCard = (props: { nombre: string, valor: number, valorPrevio?: number }) => {
    return (
        ...
        <div className="shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-800">
            ...
            <div className="flex flex-col justify-start">
                ...
                {
                    props.valorPrevio &&
                    <div className={`flex gap-1 items-center ${(props.valor - props.valorPrevio) > 0 ? "text-green-500" : "text-red-500"}  text-sm`}>
                        {
                            (props.valor - props.valorPrevio) > 0 ?
                        ...
                        <span>
                            {props.valor - props.valorPrevio}€
                        </span>
                        <span className="text-gray-400">
                            {(props.valor - props.valorPrevio) > 0 ? "más que ayer" : "menos que ayer"}
                        </span>
                    </div>
                }
            </div>
