...
const OpenedSidebar = (props: { setCollapsed: Function }) => {
    return (
        <motion.div initial={{ x: "-10vh", opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: "-10vh", opacity: 0 }}
            className="w-auto h-screen bg-white border-2 rounded-xl" onClick={() => { props.setCollapsed(true); }}>
...
const CollapsedSidebar = (props: { setCollapsed: Function }) => {
    return (
        <motion.div initial={{ x: "-10vh", opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: "-10vh", opacity: 0 }}
            className="w-auto h-screen bg-white border-2 rounded-xl" onClick={() => { props.setCollapsed(false); }}>
