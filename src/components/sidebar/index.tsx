        ...
        <motion.div initial={{ x: "-10vh", opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: "-10vh", opacity: 0 }}
            ...
            <div className="flex flex-col w-full h-full justify-between bg-white border shadow-lg rounded-3xl" onClick={() => { props.setCollapsed(true); }}>
                ...
                <div className="flex flex-col w-full h-full gap-10 justify-center px-5">
                    <Link href="/dashboard">
                        <div className={`${props.IndexSeleccionado === 0 && "bg-gray-100"} hover:text-gray-800 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                    ...
                    <Link href="/dashboard/pos" >
                        <div onClick={(e) => { props.setIndex(1); e.stopPropagation(); }} className={`${props.IndexSeleccionado === 1 && "bg-gray-100"} hover:text-gray-800 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                    ...
                    <Link href="/dashboard/productos">
                        <div onClick={(e) => { props.setIndex(2); e.stopPropagation(); }} className={`${props.IndexSeleccionado === 2 && "bg-gray-100"} hover:text-gray-800 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                        text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <Link href="/dashboard/estadisticas">
                        <div onClick={(e) => { props.setIndex(3); e.stopPropagation(); }} className={`${props.IndexSeleccionado === 3 && "bg-gray-100"} hover:text-gray-800 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                        text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`}>
                    ...
                    <Link href="/dashboard/ventas">
                        <div onClick={(e) => { props.setIndex(4); e.stopPropagation(); }} className={`${props.IndexSeleccionado === 4 && "bg-gray-100"} hover:text-gray-800 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                        text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`} >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <Link href="/dashboard/cierres">
                        <div onClick={(e) => { props.setIndex(5); e.stopPropagation(); }} className={`${props.IndexSeleccionado === 5 && "bg-gray-100"} hover:text-gray-800 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                        text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`} >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <Link href="/dashboard/clientes">
                        <div onClick={(e) => { props.setIndex(6); e.stopPropagation(); }} className={`${props.IndexSeleccionado === 6 && "bg-gray-100"} hover:text-gray-800 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                        text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`} >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className='flex flex-col w-full h-1/6 gap-10 justify-center px-5 pb-10'>
                    <Link href="/dashboard/configuracion">
                        <div onClick={(e) => { props.setIndex(7); e.stopPropagation(); }} className={`${props.IndexSeleccionado === 7 && "bg-gray-100"} 
