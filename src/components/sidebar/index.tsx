    ...
    return (
        <motion.div initial={{ x: "-10vh", opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: "-10vh", opacity: 0 }}
            ...
            <div className="flex flex-col w-full h-full justify-between bg-white border shadow-lg rounded-3xl">
                ...
                <div className="flex flex-col w-full h-full gap-6 justify-center items-stretch px-6">
                    <Link href="/dashboard">
                        <div className={`${props.IndexSeleccionado === SidebarOption.Inicio && "bg-gray-100"} hover:text-blue-500 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                    ...
                    <Link href="/dashboard/pos" >
                        <div onClick={(e) => { props.setIndex(SidebarOption.TPV); e.stopPropagation(); }} className={`${props.IndexSeleccionado === SidebarOption.TPV && "bg-gray-100"} hover:text-blue-500 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                    ...
                    <Link href="/dashboard/productos">
                        <div onClick={(e) => { props.setIndex(SidebarOption.Productos); e.stopPropagation(); }} className={`${props.IndexSeleccionado === SidebarOption.Productos && "bg-gray-100"} hover:text-blue-500 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                        text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <RequireHigherAuthorization>
                        <Link href="/dashboard/estadisticas">
                            <div onClick={(e) => { props.setIndex(SidebarOption.Estadisticas); e.stopPropagation(); }} className={`${props.IndexSeleccionado === SidebarOption.Estadisticas && "bg-gray-100"} hover:text-blue-500 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                        text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`}>
                    ...
                    <Link href="/dashboard/ventas">
                        <div onClick={(e) => { props.setIndex(SidebarOption.Ventas); e.stopPropagation(); }} className={`${props.IndexSeleccionado === SidebarOption.Ventas && "bg-gray-100"} hover:text-blue-500 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                        text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`} >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <Link href="/dashboard/cierres">
                        <div onClick={(e) => { props.setIndex(SidebarOption.Cierres); e.stopPropagation(); }} className={`${props.IndexSeleccionado === SidebarOption.Cierres && "bg-gray-100"} hover:text-blue-500 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                        text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`} >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <Link href="/dashboard/clientes">
                        <div onClick={(e) => { props.setIndex(SidebarOption.Clientes); e.stopPropagation(); }} className={`${props.IndexSeleccionado === SidebarOption.Clientes && "bg-gray-100"} hover:text-blue-500 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                        text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`} >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <RequireHigherAuthorization>
                        <Link href="/dashboard/empleados">
                            <div onClick={(e) => { props.setIndex(SidebarOption.Empleados); e.stopPropagation(); }} className={`${props.IndexSeleccionado === SidebarOption.Empleados && "bg-gray-100"} hover:text-blue-500 hover:bg-gray-100 flex items-center gap-4 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                        text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`} >
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div className='flex flex-col w-full h-1/6 gap-6 justify-center px-5 pb-10'>
                    ...
                    <Link href="/">
                        <div onClick={async (e) => { props.setIndex(SidebarOption.Ajustes); e.stopPropagation(); await fetch('/api/logout') }} className={`${props.IndexSeleccionado === SidebarOption.Salir && "bg-gray-100"} hover:text-blue-500 hover:bg-gray-100 gap-4 flex items-center transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200
                        text-gray-600 dark:text-gray-400 rounded-lg cursor-pointer`} >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <motion.div initial={{ x: "-10vh", opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: "-10vh", opacity: 0 }}
            ...
            <div className="flex flex-col h-full justify-between bg-white border shadow-lg rounded-3xl">
                ...
                <div className="flex flex-col w-full h-full xl:gap-8 gap-6 justify-center items-stretch px-5 ">
                    ...
                    <Link href="/dashboard/pos">
                        <div className={`${props.IndexSeleccionado === SidebarOption.TPV && "bg-gray-100"} hover:text-gray-800 hover:bg-gray-100 cursor-pointer dark:hover:text-white dark:hover:bg-gray-600 duration-200 text-gray-600 dark:text-gray-400 rounded-lg `}
                    ...
                    <Link href="/dashboard/productos">
                        <div onClick={(e) => { props.setIndex(SidebarOption.Productos); e.stopPropagation() }} className={`${props.IndexSeleccionado === SidebarOption.Productos && "bg-gray-100"} hover:text-gray-800 hover:bg-gray-100 cursor-pointer dark:hover:text-white dark:hover:bg-gray-600 duration-200 text-gray-600 dark:text-gray-400 rounded-lg `}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:stroke-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                            </svg>
                        </div>
                    ...
                    <Link href="/dashboard/cierres">
                        <div onClick={(e) => { props.setIndex(SidebarOption.Cierres); e.stopPropagation() }} className={`${props.IndexSeleccionado === SidebarOption.Cierres && "bg-gray-100"} hover:text-gray-800 hover:bg-gray-100 cursor-pointer dark:hover:text-white dark:hover:bg-gray-600 duration-200 text-gray-600 dark:text-gray-400 rounded-lg `} >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:stroke-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                            </svg>
                        </div>
                    ...
                    <Link href="/dashboard/clientes">
                        <div onClick={(e) => { props.setIndex(SidebarOption.Clientes); e.stopPropagation() }} className={`${props.IndexSeleccionado === SidebarOption.Clientes && "bg-gray-100"} hover:text-gray-800 hover:bg-gray-100 cursor-pointer dark:hover:text-white dark:hover:bg-gray-600 duration-200 text-gray-600 dark:text-gray-400 rounded-lg `} >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:stroke-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                            </svg>
                        </div>
                ...
                <div className='flex flex-col w-full h-1/6 xl:gap-8 gap-6 justify-center px-5 pb-10'>
                    ...
                    <Link href="/">
                        <div onClick={async (e) => { props.setIndex(SidebarOption.Salir); e.stopPropagation(); await fetch('/api/logout'); }} className={`${props.IndexSeleccionado === SidebarOption.Salir && "bg-gray-100"} hover:text-gray-800 hover:bg-gray-100 cursor-pointer dark:hover:text-white dark:hover:bg-gray-600 duration-200 text-gray-600 dark:text-gray-400 rounded-lg `} >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:stroke-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                            </svg>
                        </div>
