...
const UploadFile = (props: { tipoDocumento: TipoDocumento }) => {
    ...
    return (
        <label className="flex gap-2 px-4 py-2 text-base font-semibold text-white bg-amber-500 rounded-lg shadow-md hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-600 focus:ring-offset-2 focus:ring-offset-blue-200">
            Importar
