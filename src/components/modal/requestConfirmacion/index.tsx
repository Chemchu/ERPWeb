...
const RequestConfirmacion = (props: {
  titulo: string;
  msg: string;
        ...
        >
          <div className="w-full h-full text-center">
            <div className="flex h-full  flex-col justify-between items-center">
              ...
              <p className="text-gray-800 dark:text-gray-200 text-xl font-bold mt-4">{props.titulo}</p>
              <p className="text-gray-600 dark:text-gray-400 text-xs py-2 px-6">{props.msg}</p>
