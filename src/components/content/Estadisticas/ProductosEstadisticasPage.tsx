...
import { ProductoSummary } from "../../../tipos/ProductoSummary";
...
const ProductosEstadisticasPage = () => {
  const [mounted, setMounted] = useState<boolean>(false);
  const [producto, setProducto] = useState<ProductoSummary | undefined>();
    ...
    <div className="flex flex-col gap-4 h-full w-full bg-white sm:rounded-bl-3xl sm:rounded-tr-3xl p-4 shadow-lg border-x overflow-y-scroll">
      ...
      >
        <div className="w-full">
          <div className="w-full">Producto</div>
          <input className="rounded-lg shadow-md border w-full h-10" />
        </div>
        <div className="w-full">
