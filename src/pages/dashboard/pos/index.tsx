...
const PuntoDeVenta = (props: { isEmpleadoUsingTPV: boolean; EmpleadoSesion: SesionEmpleado }) => {
  ...
  const posState: POSState = {
    EmpleadoUsingTPVState: {
      isEmpleadoUsingTPV: empleadoUsandoTpv,
      setEmpleadoUsingTPV: setEmpleadoUsandoTPV,
    },
    AbrirCajaState: {
      showAbrirCajaModal: showModalAbrirCaja,
      setShowAbrirCajaModal: setAbrirCajaModal,
    },
    CerrarCajaState: {
      showCerrarCajaModal: showCerrarCajaModal,
      setShowCerrarCajaModal: setCerrarCajaModal,
    },
    PagarState: {
      showPagarModal: showPagarModal,
      setShowPagarModal: setShowPagarModal,
    },
    TransferirTPVState: {
      showTransferirTPVModal: showTransferirTPVModal,
      setShowTransferirTPVModal: setShowTransferirTPVModal,
    },
  };
