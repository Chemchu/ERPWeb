...
<div class="relative inline-block px-3 pt-1 text-left">
        <div on:click={() => (profileActive = !profileActive)}>
          <button
            type="button"
        ...
        {#if profileActive}
          ...
          >
            <div class="py-1" role="none">
              <a
                href="#"
                class="{profileActive ? 'bg-gray-100 text-gray-900' : 'text-gray-700' } text-gray-700 hover:bg-gray-100 hover:text-gray-900 block px-4 py-2 text-sm"
                role="menuitem"
                tabindex="-1"
